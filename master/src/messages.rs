...
use crate::master::Round;
use config::{Committee, AgentId};
...
pub struct Header {
    ...
    pub round: Round,
    pub payload: BTreeMap<Digest, AgentId>,
...
impl Header {
    pub async fn new(
        author: PublicKey,
        round: Round,
        payload: BTreeMap<Digest, AgentId>,
    ...
    pub fn verify(&self, committee: &Committee) -> DagResult<()> {
        ...
        for agent_id in self.payload.values() {
            committee
                .agent(&self.author, &agent_id)
